...
class QuestionsList extends React.Component<
	RouteComponentProps<IQuestionsParams> & IQuestionsListProps,
	IQuestionsListState
> {
...
const mapDispatchToProps = (dispatch: any): IQuestionsListDispatchProps => {
	return {
		...
		searchQuestions: (searchedText: string) => dispatch(searchQuestionsByTitle.call(searchedText)),
		getQuestionsByTag: (tag: string) => dispatch(getQuestionsByTag.call(tag)),
		getQuestionsTags: () => dispatch(getQuestionsTags.call())
	};
};
