...
import {User, PersonalInfoItem} from '../../users';
    ...
    render() {
        return (
            <div className="personal-info">
                ...
                <PersonalInfoItem infoTitle={'Preferred programming languages'}
                                  infoValue={this.props.user.personalData.progLanguages}/>
                <PersonalInfoItem infoTitle={'Working position'}
                                  infoValue={this.props.user.personalData.workingPosition.length > 0
                                      ? this.props.user.personalData.workingPosition
                                      : 'no data'}/>
                <PersonalInfoItem infoTitle={'Work experience'}
                                  infoValue={this.props.user.personalData.workExperience.length > 0
